...
public class SASAbusWidgetMarshaller_Helper extends it.bz.tis.sasabus.backend.shared.SASAbusWidgetMarshaller_Helper
{
   protected SASAbusWidgetMarshaller_Helper()
   {
      this.putClassMarshaller("it.bz.tis.sasabus.html5.shared.ui.map.SASAbusMap", new bz.davide.dmxmljson.marshalling.ClassMarshaller() {
         @Override public void marshall(Object obj, String compileTimeClassName, bz.davide.dmxmljson.marshalling.Structure structure, java.util.IdentityHashMap<Object, bz.davide.dmxmljson.marshalling.Structure> identities, long[] seq, boolean superClass) throws Exception {
            ...
            {
                     internalMarschall(value, value.getClass().getName(),"bz.davide.dmweb.shared.DMButton", structure.property("close").structure(), identities, seq, false);
            }
            // controls
            ...
            {
                     internalMarschall(value, value.getClass().getName(),"bz.davide.dmweb.shared.DMFlowPanel", structure.property("controls").structure(), identities, seq, false);
            }
            // gpsIcon
            ...
            {
                     internalMarschall(value, value.getClass().getName(),"bz.davide.dmweb.shared.DMFlowPanel", structure.property("mapDiv").structure(), identities, seq, false);
            }
            // navigationPanel
