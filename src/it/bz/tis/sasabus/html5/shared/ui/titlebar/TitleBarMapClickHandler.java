 ...
 */
public class TitleBarMapClickHandler implements DMClickHandler
{
   SASAbusMap mapWidget;

   public TitleBarMapClickHandler(SASAbusMap mapWidget)
   {
