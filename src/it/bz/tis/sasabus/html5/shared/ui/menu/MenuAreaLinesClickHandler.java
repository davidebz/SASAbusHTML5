 ...
 */
public class MenuAreaLinesClickHandler implements DMClickHandler
{
   ...
   public MenuAreaLinesClickHandler(DMHashNavigationPanel navigationPanel,
                                    Menu menu,
                                    AreaList areaList,
                                    SASAbusMap map)
   {
   ...
   MenuAreaLinesClickHandler(Void void1)
   {
